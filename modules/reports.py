...
def daily_sales_master_tab(entry_date):
    ...
    # Important:
    # render_report() ke andar already "Print View" expander hai.
    # Streamlit nested expander allow nahi karta.
    # Isliye Daily Sales Master me outer expanders remove kar diye gaye hain.
