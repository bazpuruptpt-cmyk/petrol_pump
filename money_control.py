...
def cash_tab(entry_date):
    ...
    a1.metric("Canara OD Account", format_currency(account_summary.get("Canara Bank OD Account")))
    a2.metric("Canara CC Account", format_currency(account_summary.get("Canara Bank CC Account")))
